...
<!-- vscode-markdown-toc -->
* 1. [Get The Pi 5...](#GetThePi5...)
* 2. [Raspberry Pi Imager](#RaspberryPiImager)
* 3. [Accessories/Hardware](#AccessoriesHardware)
* 4. [Setting up Raspberry Pi OS (Raspbian)](#SettingupRaspberryPiOSRaspbian)
	* 4.1. [Using SSH](#UsingSSH)
		* 4.1.1. [SSH Client](#SSHClient)
	* 4.2. [Raspberry Pi Command Line Basics](#RaspberryPiCommandLineBasics)
	* 4.3. [Turn off the lights!](#Turnoffthelights)
...
##  1. <a name='GetThePi5...'></a>Get The Pi 5...
...
##  2. <a name='RaspberryPiImager'></a>Raspberry Pi Imager
...
##  3. <a name='AccessoriesHardware'></a>Accessories/Hardware
...
##  4. <a name='SettingupRaspberryPiOSRaspbian'></a>Setting up Raspberry Pi OS (Raspbian)

###  4.1. <a name='UsingSSH'></a>Using SSH
...
####  4.1.1. <a name='SSHClient'></a>SSH Client
...
###  4.2. <a name='RaspberryPiCommandLineBasics'></a>Raspberry Pi Command Line Basics
...
Another useful command allows you to reboot the Pi from the command line, making it easy to reboot the Pi remotely.
...
###  4.3. <a name='Turnoffthelights'></a>Turn off the lights!
